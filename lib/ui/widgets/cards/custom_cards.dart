...
class SimpleCard extends StatelessWidget {
  ...
  const SimpleCard(this.note, this.onTap, {Key? key}) : super(key: key);
...
class ImageCard extends StatelessWidget {
  ...
  const ImageCard(this.note, this.onTap, {Key? key}) : super(key: key);
...
class TextImageCard extends StatelessWidget {
  ...
  const TextImageCard(this.note, this.onTap, {Key? key}) : super(key: key);
